...
export default function AdminOrdersPage() {
  ...
  const handleClearOrders = async () => {
    if (!confirm("Are you sure you want to delete ALL student orders? This action cannot be undone.")) return;
    try {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-200 shadow-xs">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-red-50 text-red-700 hover:bg-red-100 rounded-xl text-xs font-bold border border-red-200 flex items-center gap-2"
                >
                  <Trash2 className="w-4 h-4 text-red-600" /> Clear All Orders
                </button>
